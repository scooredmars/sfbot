...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('6h', '6h'), ('1bot', '1bot'), ('12h yes', '12h yes'), ('3bots yes', '3bots yes'), ('24h yes', '24h yes'), ('5bots yes', '5bots yes'), ('12h no', '12h no'), ('3bots no', '3bots no'), ('24h no', '24h no'), ('5bots no', '5bots no')], max_length=40)),
                ('icon', models.CharField(choices=[('Included', 'check icon'), ('Not included', 'times icon')], max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('STARTER', 'STARTER'), ('STANDARD', 'STANDARD'), ('PREMIUM', 'PREMIUM')], default='STARTER', max_length=21)),
                ...
                ('permissions', models.ManyToManyField(to='sfbot.PermissionList')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('create_account', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('converted_time', models.FloatField(blank=True, null=True)),
